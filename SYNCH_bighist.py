...
I = hp.read_map(intensity_fits, field=1, nest=False)
...
for method_name in ['hist']:
    ...
    np.savetxt('SYNCH_bighist_nside%s_r%s_rscale%s.xyz' %(nside,r, scale_range), ary)  
    
plt.figure(1)
hp.mollview(map=Q, fig=1, title="Mollview - Q", nest=False, norm="hist" , sub=231, xsize=2000) #, min=-5e-7, max=5e7, xsize=2000)
hp.mollview(map=U, fig=1, title="Mollview - U", nest=False, norm="hist", sub=232, xsize=2000) #, min=-5e-7, max=5e7, xsize=2000)
hp.mollview(map=polarisation_fraction, fig=1, title="Mollview - Polarisation Fraction", nest=False, norm="hist", sub=233, xsize=2000) #, min=-5e-7, max=5e7, xsize=2000)
hp.mollview(map=Q, fig=1, title="Mollview - Q", nest=False, norm=" " , sub=234, xsize=2000) #, min=-5e-7, max=5e7, xsize=2000)
hp.mollview(map=U, fig=1, title="Mollview - U", nest=False, norm=" ", sub=235, xsize=2000) #, min=-5e-7, max=5e7, xsize=2000)
hp.mollview(map=polarisation_fraction, fig=1, title="Mollview - Polarisation Fraction", nest=False, norm=" ", sub=236, xsize=2000) #, min=-5e-7, max=5e7, xsize=2000)
plt.suptitle("Polarised Synchrotron")
plt.show()
