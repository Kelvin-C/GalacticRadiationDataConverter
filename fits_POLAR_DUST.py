...
np.savetxt('DUSTPOLAR_nb%s_nside%s_rscale%s_df1_%s_df2_%s_r%s_sr%s_method%s.xyz' %(((no_of_forward+no_of_backward)*3 +2),nside, r_scale, dist_factor,dist_factor2, r, scale_range, method_name), all_data)  
...
ax.set_title('3D Vector Field - Dust')             # title
